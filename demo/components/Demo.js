...
const Demo = props => (
  <div>
    <Section
      ...
      <Row>
        <Box type='row' xs={12} sm={1} md={2} lg={1} />
        <Box type='row' xs={6} sm={1} md={7} lg={10} />
        <Box type='row' xs={6} sm={10} md={3} lg={1} />
      </Row>
      <Row>
        <Box type='row' xs={12} sm={9} md={5} lg={1} />
        <Box type='row' xs={12} sm={3} md={7} lg={11} />
      </Row>
      <Row>
        <Box type='row' xs={10} sm={6} md={4} lg={10} />
        <Box type='row' xs={2} sm={6} md={8} lg={2} />
      </Row>
      <Row>
